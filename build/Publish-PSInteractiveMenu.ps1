...
$buildScriptPath = Join-Path -Path $PSScriptRoot -ChildPath 'Build-PSInteractiveMenuPackage.ps1'
...
if ($PSCmdlet.ShouldProcess($publishTarget, "Publish PSInteractiveMenu $($buildResult.Version)")) {
    if ($DestinationPath) {
